...
<head>
    ...
    <!--====== Title ======-->
    <title>Blog - Portal Sistem Pemerintahan Berbasis Elektronik (SPBE) Pemerintah Kabupaten Madiun</title>
...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light ">
                                ...
                                <a class="navbar-brand-2" href="index.html"><img src="assets/images/logo-2.png" alt=""></a> <!-- logo -->
    ...
    <section class="footer-area pt-120">
        <div class="container">
